...
GPU_Image *logo_frames[13] = {nullptr};
...
{
  m_cd->set_state("init_event", .4f, [&]
                  { m_logger->log("Starting the IntroScene!"); });
...
{
  m_app->get_atlas()->draw_entity(m_logo, m_camera);
