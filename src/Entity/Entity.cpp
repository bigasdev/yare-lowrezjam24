...
Entity::Entity(vec2f _pos, vec2f _scale, GPU_Image *_texture, int _uid)
{
  m_pos = _pos;
  m_texture = _texture;
  m_uid = _uid;
...
GPU_Image *Entity::get_texture() { return m_texture; }
void Entity::set_texture(GPU_Image *_texture)
{
  if (_texture == nullptr)
  {
